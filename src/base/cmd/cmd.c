...
int CmdCommandEcho( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( ( c = Extra_UtilGetopt( &pOpt, argc, argv, "hn" ) ) != EOF )
    {
        switch ( c )
        {
        case 'n':
...
int CmdCommandQuit( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( ( c = Extra_UtilGetopt( &pOpt, argc, argv, "hs" ) ) != EOF )
    {
        switch ( c )
        {
        case 'h':
...
int CmdCommandHistory( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    pStr = argc == pOpt.optind+1 ? argv[pOpt.optind] : NULL;
...
int CmdCommandHelp( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( ( c = Extra_UtilGetopt( &pOpt, argc, argv, "adh" ) ) != EOF )
    {
        switch ( c )
        {
        case 'a':
...
int CmdCommandSource( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( ( c = Extra_UtilGetopt( &pOpt, argc, argv, "ipsxh" ) ) != EOF )
    {
        switch ( c )
        {
...
int CmdCommandScanDir( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( (c = Extra_UtilGetopt( &pOpt, argc, argv, "D") ) != EOF )
    {
        switch (c)
        {
            case 'D':
...
int CmdCommandRenameFiles( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( (c = Extra_UtilGetopt( &pOpt, argc, argv, "DENB") ) != EOF )
    {
        switch (c)
        {
            case 'D':
...
int CmdCommandLs( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( (c = Extra_UtilGetopt( &pOpt, argc, argv, "lb") ) != EOF )
    {
        switch (c)
        {
            case 'l':
...
int CmdCommandScrGen( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( (c = Extra_UtilGetopt( &pOpt, argc, argv, "FRCWch") ) != EOF )
    {
        switch (c)
        {
        case 'F':
...
int CmdCommandScrGenLinux( Abc_Frame_t * pAbc, int argc, char **argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( (c = Extra_UtilGetopt( &pOpt, argc, argv, "FRCWEbh") ) != EOF )
    {
        switch (c)
        {
        case 'F':
...
int CmdCommandStarter( Abc_Frame_t * pAbc, int argc, char ** argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( ( c = Extra_UtilGetopt( &pOpt, argc, argv, "PCvh" ) ) != EOF )
    {
        switch ( c )
        {
        case 'P':
...
int CmdCommandAutoTuner( Abc_Frame_t * pAbc, int argc, char ** argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( ( c = Extra_UtilGetopt( &pOpt, argc, argv, "NCFvh" ) ) != EOF )
    {
        switch ( c )
        {
        case 'N':
...
int CmdCommandSGen( Abc_Frame_t * pAbc, int argc, char ** argv )
{
    ...
    Extra_UtilOpt_t pOpt = { NULL, 0, NULL };
    while ( ( c = Extra_UtilGetopt( &pOpt, argc, argv, "NIvh" ) ) != EOF )
    {
        switch ( c )
        {
        case 'N':
